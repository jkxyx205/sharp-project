...
public class FastDFSInputStreamStoreTest {
    ...
    public void testPropertyStore() throws IOException {
        StoreResponse response = inputStreamStore.store("upload", "jpeg",
    ...
    @Order(2)
    public void getURL(){
        String url = inputStreamStore.getURL("upload", path);
    ...
    public void getInputStream() throws IOException {
        InputStream is = inputStreamStore.getInputStream("upload", path);
    ...
    public void testPropertyDelete() throws IOException {
        inputStreamStore.delete("upload", path);
    }
}
