...
public final class SecurityConstants {
	 ...
	 * 默认登录页面
	 */
	public static final String DEFAULT_SIGN_IN_PAGE_URL = "/sharp-security-signIn.html";
	/**
	 ...
	 * session失效默认的跳转地址
	 */
	public static final String DEFAULT_SESSION_INVALID_URL = "/sharp-security-session-invalid.html";
}
