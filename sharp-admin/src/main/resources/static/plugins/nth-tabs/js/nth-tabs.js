...
(function ($) {
    ...
    $.fn.nthTabs = function (options) {
        ...
        var template =
            '<div class="page-tabs">' +
            '<a href="javascript:;" class="roll-nav roll-nav-left"><span class="fa fa-angle-double-left"></span></a>' +
            '<div class="content-tabs">' +
            '<div class="content-tabs-container">' +
            '<ul class="nav nav-tabs nav-tabs-s"></ul>' +
            '</div>' +
            '</div>' +
            '<a href="javascript:;" class="roll-nav roll-nav-right"><span class="fa fa-angle-double-right"></span></a>' +
            '<div class="dropdown roll-nav right-nav-list">' +
            '<a href="javascript:;" id="nth-tab-right-nav-list" class="dropdown-toggle" data-toggle="dropdown">' +
        ...
        var methods = {
            ...
            getActiveId: function () {
                return nthTabs.find("a.active").attr("href").replace('#', '');
            },
            ...
            delOtherTab: function () {
                nthTabs.find(".nav-tabs li").not('[not-allow-close]').find('a').not('[class="active"]').parent().remove();
        ...
        var event = {
            ...
            // 选项卡清单
            onTabList: function () {
                $('#nth-tab-right-nav-list').on('click', function () {
