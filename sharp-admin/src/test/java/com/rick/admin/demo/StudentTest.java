...
//                .tplName("tpl/ajax_list") // 没有特殊要求使用模版页面
                ...
                .queryFieldList(Arrays.asList(
                        ...
                        new QueryField("available", "状态", QueryField.Type.SELECT, "bool"),
                ...
                .reportColumnList(Arrays.asList(
                        ...
                        new ReportColumn("marriage", "婚否", false,"bool", Arrays.asList("boolConverter")),
                        ...
                        new ReportColumn("available", "状态", false, "bool", Arrays.asList("boolConverter")),
